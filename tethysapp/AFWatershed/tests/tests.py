...
# from ..app import WatershedAfgan
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_afgan"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_afgan.tests.tests"

        To run tests in the WatershedAfganTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_afgan.tests.tests.WatershedAfganTestCase"

        To run only the test_if_tethys_platform_is_great function in the WatershedAfganTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.watershed_afgan.tests.tests.WatershedAfganTestCase.test_if_tethys_platform_is_great"
...
class WatershedAfganTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(WatershedAfgan)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(WatershedAfgan)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/AFWatershed/')  # The final '/' is essential for all pages/controllers
